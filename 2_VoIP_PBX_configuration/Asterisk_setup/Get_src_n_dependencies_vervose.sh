...
# NOTE: We are not including any compiled libraries as asterisk will compile them itself when needed! We are noting the ones that will
# installed by default at least on our Ubuntu Bionic system
